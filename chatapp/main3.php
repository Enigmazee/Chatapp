...
<ul>
  ...
  <li><a href="addloc.php" target="msgframe">Add Tape Location</a></li>
  <li><a href="removeloc.php" target="msgframe">Delete Tape Location</a></li>
  <li><a href="addtape.php" target="msgframe">Add Tape</a></li>
  <li><a href="removetape.php" target="msgframe">Delete Tape</a></li>
  <li><a href="approvemvt.php" target="msgframe">Approve Tape Movement</a></li>';} ?>
  <li><a href="recordmovt.php" target="msgframe">Record Tape Movement</a></li>
  <li><a href="viewmovt.php" target="msgframe">View Movement Details</a></li>
  <li><a href="viewtape.php" target="msgframe">View Tape Details</a></li>
</ul>
</div>
