...
<body>
<div><h1 class="h1">ABC Corp. Backup Administration Module</h1></div>
...
<ul>
  <li><a href="main.php">Return to Home</a></li><?php if ($category == "2"){echo'
  <li><a href="approvebackup.php" target="msgframe">Approve Backup</a></li>
  <li><a href="deletebackup.php" target="msgframe">Delete Backup Job</a></li>';} ?>
  <li><a href="addbackup.php" target="msgframe">Add New Backup Job</a></li>
  <li><a href="recordbackup.php" target="msgframe">Record Daily Backup</a></li>
  <li><a href="markfailed.php" target="msgframe">Mark Failed Backup Job</a></li>
  <li><a href="viewbackup.php" target="msgframe">View Backup Register</a></li>
  <li><a href="logout.php" >Log out</a></li>
</ul>
</div>
<iframe class="frame" name="msgframe" > </iframe>
<hr>
