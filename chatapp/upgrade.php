...
$sql = "select * from users where category = '1' order by fname, sname desc";
...
if (mysqli_num_rows($result) > 0) {
	...
	echo '</select>&nbsp;&nbsp;<input style="font-family:Century Gothic;font-weight:bold; font-size:15px"type="submit" value ="Upgrade User" ><br><br><br><br></fieldset></form>';
} else {
    echo "<h1 style='background-color:#CCC'>No Non-Admin Users!</h1>";
}

if (isset ($_POST['selection']) && $_POST['selection'] != ""){
	$selection = $_POST['selection'];
	$sql = "UPDATE users SET category = '2' WHERE id = '$selection'";
	$result = mysqli_query($mainconn, $sql);
