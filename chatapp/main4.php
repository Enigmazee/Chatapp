...
<ul>
  <li><a href="main.php">Return to Home</a></li></li><?php if ($category == "2"){echo'
  <li><a href="enable.php" target="msgframe">Enable User</a></li>
  <li><a href="upgrade.php" target="msgframe">Upgrade User to Admin</a></li>
  <li><a href="downgrade.php" target="msgframe">Downgrade Admin to user</a></li>
  <li><a href="disable.php" target="msgframe">Disable User</a></li>';} ?>
  <li><a href="change.php" target="msgframe">Change Password</a></li>
